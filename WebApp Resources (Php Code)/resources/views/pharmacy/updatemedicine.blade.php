...
@csrf
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" name="Formula" value="{{$product->Formula}}" class="form-control" id="Gram"
									placeholder="add Formula">
							</div>
						</div>
						<br>
						<div class="form-group row">
							<label for="formula" class="col-sm-2 col-form-label">Quantity</label>
							<div class="col-sm-6">
							  <input type="text" name="quantity" value="{{$product->quantity}}" class="form-control" id="Gram" placeholder="Quantity">
							</div>
						  </div>
						  <br>
						<div class="form-group row">
