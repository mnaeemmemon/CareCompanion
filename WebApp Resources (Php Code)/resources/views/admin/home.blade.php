	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
			...
			<div class="col-6 col-lg-3">
				<div class="app-card app-card-stat shadow-sm h-100 gren">
					<div class="app-card-body p-3 p-lg-4">
						...
						<div class="stats-figure">{{$pharmacy}}</div>
						<div class="stats-meta text-success">
			...
			<div class="col-6 col-lg-3">
				<div class="app-card app-card-stat shadow-sm h-100 gren">
					<div class="app-card-body p-3 p-lg-4">
						...
						<div class="stats-figure">{{$delboys}}</div>
		...
		<div class="app-card app-card-notification shadow-sm mb-4">
			...
			<div class="app-card-header px-4 py-3">
				...
				<a href="{{ url('mark_as_read',$not->id) }}"> <button style="width:120px;" class="btn btn-info float-right">Mark as Seen</button> </a>
		...
		<!--//app-card-->
		<div class="text-center mt-4"><a class="btn app-btn-secondary" href="{{url('/adminnotifications')}}">See more
				notifications</a></div>
