        ...
        <div class="container-xl">
            <div class="p-4 bg-white rounded">
                ...
                <div class="all-form-element-inner">
                    ...
                    <form action="{{url('admin_update_pharmacy')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$p->city}}" name="city" class="form-control" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$p->contact}}" name="contact" class="form-control" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$p->Account_ID}}" name="account" class="form-control" />
                                </div>
                            </div>
                        </div>
{{--                         
