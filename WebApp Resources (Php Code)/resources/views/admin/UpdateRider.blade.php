    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="p-4 bg-white rounded">
                <h1 class="app-page-title">Add Rider</h1>

                <div class="all-form-element-inner">
                    {{-- <form action="{{url('rider.add')}}" method="post" enctype="multipart/form-data"> --}}
                    <form action="{{url('update_rider_Confirm')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="hidden" value="{{$d->id}}" name="id" class="form-control" />
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$d->contact}}" name="contact" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$d->password}}" name="password" class="form-control" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$d->Area_ID}}" name="area" class="form-control" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" value="{{$d->Account_ID}}" name="account" class="form-control" />
                                </div>
                            </div>
                        </div>
{{--                         
