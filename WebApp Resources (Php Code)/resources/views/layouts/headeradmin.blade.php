					...
					<div class="app-header-content">
						<div class="row justify-content-between align-items-center">
							...
							<div class="app-search-box col">
								<form class="app-search-form" method="post" action="{{url('Admin_Search')}}">
									@csrf
									<input type="hidden" placeholder="{{$search_helper}}" name="helper" value="{{$search_helper}}"
								...
								<div class="app-utility-item app-user-dropdown dropdown">
									<a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown"
										href="#" role="button" aria-expanded="false"><img
											src="assets/images/users/admin-ui.png" alt="user profile"></a>
			...
			<div id="app-sidepanel" class="app-sidepanel">
				...
				<div class="sidepanel-inner d-flex flex-column">
					...
					<div class="app-branding">
						<a class="app-logo" href="{{url('/adminhome')}}"><img class="logo-icon me-2"
								src="{{asset('assets/images/app-logo.svg')}}" alt="Care companion Logo"></a>
						...
						<ul class="app-menu list-unstyled accordion" id="menu-accordion">
								...
								{{-- <div class=" nav-link"> --}}
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
										<a class="dropdown-item"
											href="{{url('/admindeliveriesSection')}}">Deliveries</a>
										<a class="dropdown-item" href="{{url('/admindelivery')}}">Rider Info</a>
										<a class="dropdown-item" href="{{url('/adminDeliveryAddRider')}}">Add Rider</a>
							...
							<li class="nav-item">
								{{-- <div class=" nav-link"> --}}
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
										<a class="dropdown-item" href="{{url('/adminpharmacy')}}">Pharmacy Info</a>
										<a class="dropdown-item" href="{{url('/AdminAddPharmacy')}}">Add Pharmacy</a>
							...
							<li class="nav-item">
								{{-- <div class=" nav-link"> --}}
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
										<a class="dropdown-item" href="{{url('/AdminTransactions')}}">Transactions</a>
										<a class="dropdown-item" href="{{url('/AdminSellerAccounts')}}">Seller
											Accounts</a>
										<a class="dropdown-item" href="{{url('/AdminAccountStatus')}}">Account
											Status</a>
									</div>
							</li>
