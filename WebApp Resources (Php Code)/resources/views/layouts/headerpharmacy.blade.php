				...
				<div class="app-header-content">
					<div class="row justify-content-between align-items-center">
						...
						<div class="app-search-box col">
							<form class="app-search-form" method="post" action="{{url('Pharmacy_Search')}}">
								@csrf
				...
				<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
								...
								<ul class="submenu-list list-unstyled">
									...
									<li class="submenu-item"><a class="submenu-link"
											...
											<li class="submenu-item"><a class="submenu-link"
												...
												<li class="submenu-item"><a class="submenu-link"
													href="{{url('/pharmacycategorylist')}}">Category List</a></li>
						...
						<li class="nav-item has-submenu">
							...
							<!--//nav-link-->
							<div id="submenu-" class="collapse submenu submenu-" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
											href="{{url('/PharmacyTransactions')}}">Transactions</a></li>
									
									<li class="submenu-item"><a class="submenu-link"
												href="{{url('/PharmacyAccountStatus')}}">Account Status</a></li>
